...
recipes.addShaped(<randomthings:spectreaxe>, [	[<contenttweaker:spectreplate>, <contenttweaker:spectreplate>, null], 	[<contenttweaker:spectreplate>, <ore:stickObsidian>, null], 	[null, <ore:stickObsidian>, null]]);
recipes.addShaped(<randomthings:spectrepickaxe>, [	[<contenttweaker:spectreplate>, <contenttweaker:spectreplate>, <contenttweaker:spectreplate>], 	[null, <ore:stickObsidian>, null], 	[null, <ore:stickObsidian>, null]]);
recipes.remove(<randomthings:spectrepickaxe>);
recipes.addShaped(<randomthings:spectresword>, [	[null, <contenttweaker:spectreplate>, null], 	[null, <contenttweaker:spectreplate>, null], 	[null, <ore:stickObsidian>, null]]);
recipes.remove(<randomthings:spectresword>);
recipes.addShaped(<randomthings:spectreshovel>, [	[null, <contenttweaker:spectreplate>, null], 	[null, <ore:stickObsidian>, null], 	[null, <ore:stickObsidian>, null]]);
