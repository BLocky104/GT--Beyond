...
recipes.addShaped(<pneumaticcraft:turbine_rotor>, [	[null, <pneumaticcraft:turbine_blade>, null], 	[null, <ic2:crafting:35>, null], 	[<pneumaticcraft:turbine_blade>, null, <pneumaticcraft:turbine_blade>]]);
...
recipes.addShaped(<pneumaticcraft:plastic_mixer>, [	[<advanced_solar_panels:crafting:6>, <pneumaticcraft:capacitor>, <advanced_solar_panels:crafting:6>],     [<pneumaticcraft:transistor>, <thermalexpansion:frame:129>, <pneumaticcraft:transistor>], 	[<ore:blockIronCompressed>, <ic2:resource:13>, <ore:blockIronCompressed>]]);
recipes.addShaped(<pneumaticcraft:cannon_barrel>, [    [<ore:ingotIronCompressed>, <advanced_solar_panels:crafting:3>, null], 	[<pneumaticcraft:pressure_tube>, <ore:plasticBlack>, <ore:plasticBlack>], 	[<ore:ingotIronCompressed>, <advanced_solar_panels:crafting:3>, null]]);
...
recipes.addShaped(<pneumaticcraft:electric_compressor>, [[<ore:circuitUev>, <contenttweaker:advancedalloygear>, <pneumaticcraft:printed_circuit_board>], 	[<ore:itemInsulatedGlassCable>, <pneumaticcraft:turbine_rotor>, <pneumaticcraft:advanced_pressure_tube>], 	[<ore:circuitUev>, <pneumaticcraft:advanced_air_compressor>, <pneumaticcraft:printed_circuit_board>]]);
...
mods.pneumaticcraft.pressurechamber.addRecipe([<gregtech:meta_item_1:10075>*2,<minecraft:glowstone_dust>*4] , 1.0 , [<advanced_solar_panels:crafting:3>]);
