...
recipes.addShaped(<galacticraftcore:sensor_lens>, [	[<ore:plateRedstone>, <galacticraftcore:space_glass_clear>, <ore:plateRedstone>], 	[<galacticraftcore:space_glass_clear>, <ore:compressedMeteoricIron>, <galacticraftcore:space_glass_clear>], 	[<ore:plateRedstone>, <galacticraftcore:space_glass_clear>, <ore:plateRedstone>]]);
recipes.addShaped(<galacticraftcore:sensor_glasses>.withTag({}), [	[<ore:stickDesh>, null, <ore:stickDesh>], 	[<galacticraftcore:sensor_lens>, <ore:gearSmallSteel>, <galacticraftcore:sensor_lens>], 	[<ore:stickDesh>, null, <ore:stickDesh>]]);



recipes.remove(<galacticraftcore:sensor_glasses>.withTag({}));
...
assembler.recipeBuilder()
    .inputs(<gregtech:meta_item_1:12001>*4,<extrautils2:decorativeglass>*4,<qmd:containment_glass>)
    .outputs(<galacticraftcore:space_glass_clear>*4)
    .duration(220)
    .EUt(480)
    .buildAndRegister();
