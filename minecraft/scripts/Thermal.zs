...
recipes.addShaped(<thermalexpansion:capacitor:2>.withTag({Energy: 0}), [	[<enderio:item_basic_capacitor>, <ore:ingotRedstoneAlloy>,<enderio:item_basic_capacitor>], 	[<ic2:heat_storage>, <thermalexpansion:capacitor:1>, <ic2:heat_storage>], 	[<ore:plateElectrum>, <ore:ingotRedstoneAlloy>, <ore:plateElectrum>]]);
...
recipes.addShaped(<thermalfoundation:material:640>, [ 	[<ore:stickSteel>, <ore:screwIron>, <ore:stickSteel>],  	[<ic2:casing:2>, <ore:plateRedstone>, <ic2:casing:2>],  	[<ic2:casing:2>, <ic2:casing:2>, <ic2:casing:2>] ]);
