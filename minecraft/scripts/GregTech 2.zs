...
ebf.recipeBuilder()
    ...
    .outputs(<contenttweaker:infusedgoldtrioxide>,<gregtech:meta_item_1:2016>)
...
assembler.recipeBuilder()
    ...
    .outputs(<modularmachinery:liquidcollector_controller>)
    .duration(400)
    .EUt(500000)
    .buildAndRegister();
...
bio.recipeBuilder()
    .inputs(<galacticraftplanets:strange_seed:1>*2,<gregtech:meta_item_1:2307>)
