...
recipes.addShaped(<ic2:te:32>, [	[<ic2:casing:4>, <enderio:item_basic_capacitor>, <ic2:casing:4>], 	[<gtadditions:ga_transparent_casing>, <gregtech:meta_item_1:32611>, <gtadditions:ga_transparent_casing>], 	[<ic2:casing:4>, <ore:machineBlock>, <ic2:casing:4>]]);
...
recipes.addShaped(<energycontrol:info_panel>, [	[<ore:paneGlass>, <ore:paneGlass>, <ore:paneGlass>], 	[<enderio:item_basic_capacitor>, <ic2:resource:13>, <enderio:item_basic_capacitor>], 	[<contenttweaker:keyboard>, <ic2:upgrade:1>, <ore:itemInsulatedGlassCable>]]);
...
recipes.remove(<reactor_stuff:uranium_233_nugget>);
furnace.remove(<reactor_stuff:uranium_ingot>);
recipes.remove(<reactor_stuff:thorium_rod>);
recipes.remove(<reactor_stuff:thorium_rod_dual>);
recipes.remove(<reactor_stuff:thorium_rod_quad>);
...
recipes.remove(<reactor_stuff:uranium_233_chunk>);
...
furnace.remove(<reactor_stuff:thorium_ingot>);
...
thermal.recipeBuilder()
    .inputs(<reactor_stuff:depleted_thorium_rod>)
    .outputs(<gregtech:meta_item_1:9821>*6,<reactor_stuff:thorium_chunk>*2,<gregtech:meta_item_1:2033>)
    .duration(400)
    .EUt(2000)
    .buildAndRegister();

thermal.recipeBuilder()
    .inputs(<reactor_stuff:depleted_thorium_rod_dual>)
    .outputs(<gregtech:meta_item_1:9821>*12,<reactor_stuff:thorium_chunk>*4,<gregtech:meta_item_1:2033>*3)
    .duration(400)
    .EUt(2000)
    .buildAndRegister();

thermal.recipeBuilder()
    .inputs(<reactor_stuff:depleted_thorium_rod_quad>)
    .outputs(<gregtech:meta_item_1:9821>*24,<reactor_stuff:thorium_chunk>*8,<gregtech:meta_item_1:2033>*6)
    .duration(400)
    .EUt(2000)
    .buildAndRegister();