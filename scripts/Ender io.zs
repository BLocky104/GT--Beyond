...
recipes.addShaped(<enderio:block_dark_iron_bars> * 8, [	[null, <ore:craftingToolWrench>, null], 	[<contenttweaker:bulatsteelrod>, <contenttweaker:bulatsteelrod>, <contenttweaker:bulatsteelrod>], 	[<contenttweaker:bulatsteelrod>, <contenttweaker:bulatsteelrod>, <contenttweaker:bulatsteelrod>]]);
...
recipes.addShaped(<contenttweaker:electricalsteeldust>, [	[<ore:dustSilicon>, <ore:dustRegularIron>, <ore:dustRegularIron>], 	[<ore:dustCoal>, null, null], 	[null, null, null]]);
...
recipes.remove(<enderio:item_redstone_nor_filter>);
recipes.remove(<enderio:item_redstone_nand_filter>);
recipes.remove(<enderio:item_redstone_xnor_filter>);
recipes.remove(<enderio:item_redstone_or_filter>);
recipes.remove(<enderio:item_redstone_and_filter>);
...
recipes.addShaped(<enderio:item_yeta_wrench>, [	[<ore:ingotPulsatingIron>, <ore:craftingToolWrench>, <ore:ingotPulsatingIron>], 	[<ore:ingotPulsatingIron>, <ore:ingotPulsatingIron>, <ore:ingotPulsatingIron>], 	[null, <ore:ingotPulsatingIron>, null]]);
...
mixer.recipeBuilder()
    .inputs(<enderio:item_material:67>*3,<gregtech:meta_item_1:2522>*2,<galacticraftcore:basic_item:2>*2)
