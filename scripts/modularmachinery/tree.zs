...
RecipeBuilder.newBuilder("tree9", "tree", 200)    .addEnergyPerTickInput(500)    .addFluidInput(<liquid:water>*2000)    .addItemInput(<galaxyspace:barnarda_c_dandelions:12>) .addItemOutput(<galaxyspace:barnarda_c_dandelions:12>) .addItemOutput(<galaxyspace:barnarda_c_test_log>*2) .build();
...
RecipeBuilder.newBuilder("tree11", "tree", 200)    .addEnergyPerTickInput(500)    .addFluidInput(<liquid:water>*2000)    .addItemInput(<moreplanets:infected_oak_sapling>) .addItemOutput(<moreplanets:infected_oak_sapling>) .addItemOutput(<moreplanets:infected_oak_log>*2) .build();
RecipeBuilder.newBuilder("tree12", "tree", 200)    .addEnergyPerTickInput(500)    .addFluidInput(<liquid:water>*2000)    .addItemInput(<moreplanets:infected_spruce_sapling>) .addItemOutput(<moreplanets:infected_spruce_sapling>) .addItemOutput(<moreplanets:infected_spruce_log>*2) .build();
RecipeBuilder.newBuilder("tree13", "tree", 200)    .addEnergyPerTickInput(500)    .addFluidInput(<liquid:water>*2000)    .addItemInput(<moreplanets:infected_jungle_sapling>) .addItemOutput(<moreplanets:infected_jungle_sapling>) .addItemOutput(<moreplanets:infected_jungle_log>*2) .build();
RecipeBuilder.newBuilder("tree14", "tree", 200)    .addEnergyPerTickInput(500)    .addFluidInput(<liquid:water>*2000)    .addItemInput(<moreplanets:alien_berry_oak_sapling>) .addItemOutput(<moreplanets:alien_berry_oak_sapling>) .addItemOutput(<moreplanets:alien_berry_oak_log>*2) .build();
RecipeBuilder.newBuilder("tree9", "tree", 200)    .addEnergyPerTickInput(500)    .addFluidInput(<liquid:water>*2000)    .addItemInput(<moreplanets:oscalea_sapling>) .addItemOutput(<moreplanets:oscalea_sapling>) .addItemOutput(<moreplanets:oscalea_log>*2) .build();
RecipeBuilder.newBuilder("tree10", "tree", 200)    .addEnergyPerTickInput(500)    .addFluidInput(<liquid:water>*2000)    .addItemInput(<moreplanets:frolia_sapling>) .addItemOutput(<moreplanets:frolia_sapling>) .addItemOutput(<moreplanets:frolia_log>*2) .build();
